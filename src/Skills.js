  ...
  return(
     <div className="grid-container">
       ...
       <div className="box">
           ...
           <p className="p2">I have built a Travel Application with one of my colleagues. On this application, users can authenticate and make reservations to different hotels around the world. We used Flutter for frontend  and  Firebase for backend.</p>
           ...
           <p className="p2"> 15.09.2014 - 10.06.2018: Grigore Moisil High School.</p>
